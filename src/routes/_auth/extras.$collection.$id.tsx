    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 m-4 gap-4 items-start">
                {data.map((extra) => (
                    <div
                        className="p-3 shadow-sm bg-white dark:bg-black dark:shadow-gray-500/50 flex flex-col gap-1"
                        key={extra.id}
                    >
                        <Link
                            className="cursor-pointer flex gap-2 with-action"
                        ...
                        <div className="ms-2 flex gap-4">
                            <button
                                className="cursor-pointer with-action"
